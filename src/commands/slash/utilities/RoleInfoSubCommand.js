...
module.exports = class RoleInfoSubCommand extends SubCommand {
	...
	async run(ctx) {
		...
		const embed = new Discord.MessageEmbed()
            ...
            .addField('||\n||', '||\n||', true)
            .addField(`:busts_in_silhouette: ${ctx.t('role_info:texts.roleMembers')}:`, `${role.members.size}`, true)
            ...
            .addField(`:robot: ${ctx.t('role_info:texts.roleManaged')}`, `${ctx.t(`general:booleans.${!!role.managed}`)}`, true)
