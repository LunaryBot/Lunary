...
module.exports = class PingCommand extends Command {
     ...
     */
    async run(ctx) {
        if(ctx.interaction.options.getString("type") == "clusters") {
            ...
            let a = `**:ping_pong:•Pong!**\n**:satellite_orbital: | Shard:** ${Number(ctx.interaction.guild.shardId) + 1} - [<:foguete:871445461603590164> Cluster ${Number(this.client.cluster.id) + 1} (${this.client.config.clusterName[this.client.cluster.id]})]\n**⚡ | Shard Ping:** \`${this.client.ws.ping}ms\`\n**⏰ | Gateway Ping:**`
