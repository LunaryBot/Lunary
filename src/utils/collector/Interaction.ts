...
class InteractionCollector extends BaseCollector {
    ...
    constructor(client: Client, options: ICollectorInteractionOptions = {} as ICollectorInteractionOptions) {
        ...
        client.on("interactionCreate", this.handleCollect.bind(this));
        ...
        this.once("end", () => {
            client.removeListener("interactionCreate", this.handleCollect.bind(this));
    ...
    private collect(interaction: Interaction) {
