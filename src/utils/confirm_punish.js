...
module.exports = function confirm_punishment(ctx, user, reason, time) {
	...
	const data = {
		embeds: [embed],
		components: [new Discord.MessageActionRow().addComponents([new Discord.MessageButton().setCustomId('confirm_punish').setStyle('SUCCESS').setEmoji('872635474798346241'), new Discord.MessageButton().setCustomId('cancel_punish').setStyle('DANGER').setEmoji('872635598660313148')])],
	};
