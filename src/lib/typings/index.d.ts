...
export type GuildCacheMessage<Cached extends GuildCacheState> =
	CacheTypeReducer<
		Cached,
		Message,
		APIMessage,
...
export interface BaseGuildCommandInteraction<
...
export abstract class BaseCommandInteraction extends Interaction {
	...
	public inCachedGuild(): this is BaseGuildCommandInteraction<"cached"> &
		this;
...
export class CategoryChannel extends GuildChannel {
	...
	public createChannel(
		...
		TextChannel | VoiceChannel | NewsChannel | StoreChannel | StageChannel
	>;
}
...
export class CommandInteractionOptionResolver {
	...
	public getUser(
		name: string,
		required?: boolean
	): NonNullable<CommandInteractionOption["user"]> | null;
	public getMember(
		name: string,
		required: true
	...
	public getMember(
		name: string,
		required?: boolean
	): NonNullable<CommandInteractionOption["member"]> | null;
	public getRole(
		name: string,
		required: true
...
export class Guild extends AnonymousGuild {
	...
	public defaultMessageNotifications:
...
type CollectorOptionsTypeResolver<
	U extends InteractionCollectorOptionsResolvable
> = {
	readonly [T in U["componentType"]]: TaggedUnion<
...
type ConditionalInteractionCollectorType<
...
type MappedInteractionCollectorOptions =
	CollectorOptionsTypeResolver<InteractionCollectorOptionsResolvable>;

// Converts mapped types to complimentary collector types.
type InteractionCollectorReturnType<
...
type InteractionExtractor<
	T extends MessageComponentType | MessageComponentTypes | undefined
> = T extends MessageComponentType | MessageComponentTypes
	? MappedInteractionCollectorOptions[T] extends InteractionCollectorOptions<
			infer Item
	  >
		? Item
		: never
...
export class Message extends Base {
	...
	public awaitMessageComponent<
		T extends
			| MessageComponentType
			| MessageComponentTypes
			| undefined = MessageComponentTypes.ACTION_ROW
	>(
...
export class MessageAttachment {
	public constructor(
		...
		name?: string,
		data?: RawMessageAttachementData
	);
...
export class SelectMenuInteraction extends MessageComponentInteraction {
	public constructor(
		client: Client,
		data: RawMessageSelectMenuInteractionData
	);
...
export class Shard extends EventEmitter {
	...
	public on(
		event: "spawn" | "death",
		listener: (child: ChildProcess) => Awaitable<void>
	): this;
	public on(
		event: "disconnect" | "ready" | "reconnecting",
		listener: () => Awaitable<void>
	): this;
	public on(
		event: "error",
		listener: (error: Error) => Awaitable<void>
	): this;
	public on(
		event: "message",
		listener: (message: any) => Awaitable<void>
	): this;
	public on(
		event: string,
		listener: (...args: any[]) => Awaitable<void>
...
export class WebSocketShard extends EventEmitter {
	...
	public on(
		event: "close",
		listener: (event: CloseEvent) => Awaitable<void>
	): this;
	public on(
		event: "allReady",
		listener: (unavailableGuilds?: Set<Snowflake>) => Awaitable<void>
	): this;
	public on(
		event: string,
		listener: (...args: any[]) => Awaitable<void>
...
type ExcludeEnum<T, K extends keyof T> = Exclude<
	keyof T | T[keyof T],
	K | T[K]
>;
...
export const Constants: {
	...
	Endpoints: {
		...
		CDN: (root: string) => {
			...
			Sticker: (
				stickerId: Snowflake,
				stickerFormat: StickerFormatType
			) => string;
			RoleIcon: (
				roleId: Snowflake,
				hash: string,
...
> {
	...
	public create(
		name: string,
		options: GuildChannelCreateOptions & { type: "GUILD_VOICE" }
	): Promise<VoiceChannel>;
	public create(
		name: string,
	...
	public create(
		name: string,
		options?: GuildChannelCreateOptions & { type?: "GUILD_TEXT" }
	): Promise<TextChannel>;
	public create(
		name: string,
		options: GuildChannelCreateOptions & { type: "GUILD_NEWS" }
	): Promise<NewsChannel>;
	public create(
		name: string,
		options: GuildChannelCreateOptions & { type: "GUILD_STORE" }
	): Promise<StoreChannel>;
	public create(
		name: string,
...
> {
	...
	public edit(
		message: MessageResolvable,
		options: MessagePayload | MessageEditOptions
	): Promise<Message>;
	public fetch(
		message: Snowflake,
		options?: BaseFetchOptions
...
> {
	private constructor(
		guild: Guild,
		iterable?: Iterable<RawStageInstanceData>
	);
	public guild: Guild;
	public create(
...
> {
	...
	public create(
		options: ThreadCreateOptions<AllowedThreadType>
	): Promise<ThreadChannel>;
	public fetch(
...
export function TextBasedChannel<
	T,
...
export type GuildVoiceChannelResolvable =
	| VoiceChannel
	| StageChannel
	| Snowflake;
...
export interface ButtonInteractionCollectorOptions
	extends MessageComponentCollectorOptions<ButtonInteraction> {
	componentType: "BUTTON" | MessageComponentTypes.BUTTON;
}

export interface SelectMenuInteractionCollectorOptions
...
export interface InteractionReplyOptions
	extends Omit<WebhookMessageOptions, "username" | "avatarURL"> {
	ephemeral?: boolean;
	fetchReply?: boolean;
}
...
export interface PartialGuildMember
	extends Partialize<GuildMember, "joinedAt" | "joinedTimestamp", "user"> {}
